...
A customer with negotiated pricing, a specific tier, or established [payment terms](/blog/net-30-60-90-terms-in-industrial-distribution-what-actually-works) should see exactly that when they log in — not a generic public price list that doesn't reflect their actual relationship. This is where generic [ecommerce checkout tools](/blog/what-is-b2b-ecommerce-a-complete-guide) often fall short for B2B: they weren't built around the idea that different logged-in customers should see fundamentally different prices and terms for the same product, which is standard in industrial distribution but unusual in consumer retail.
...
- **Offer it as an addition, not a replacement, at least initially** — Let customers discover the value of self-service for [routine reorders](/blog/b2b-reordering-is-broken-and-why-that-matters) while knowing the phone and email options haven't gone anywhere.
