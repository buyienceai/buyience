...
Moving stock between warehouses — to rebalance inventory, respond to seasonal demand spikes or regional demand shifts, or consolidate for a large order — needs its own clear process, because a transfer in progress is inventory that exists but isn't cleanly assignable to either location's available count.
