...
Volume discounts rarely operate in isolation — most distributors also have [customer-based tiered pricing](https://buyience.com/blog/how-b2b-teams-manage-customer-specific-pricing-at-scale) layered on top (a topic covered in more depth in our [tiered pricing setup guide](https://buyience.com/blog/tiered-pricing-for-fastener-and-mro-distributors-a-practical-setup-guide)). The interaction between the two needs an explicit rule, not an assumption:
