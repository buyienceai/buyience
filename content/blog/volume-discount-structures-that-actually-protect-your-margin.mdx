...
<figure className="blog-inline-figure">
  <img src="/blog/covers/volume-discount-structures-margin-floor.png" alt="Set the margin floor before the discount — every volume break starts with the minimum profitable price" />
</figure>
...
<figure className="blog-inline-figure">
  <img src="/blog/covers/volume-discount-structures-customers-actually-buy.png" alt="Set break points where customers actually buy — use real order-size distribution, not round numbers" />
</figure>
...
<figure className="blog-inline-figure">
  <img src="/blog/covers/volume-discount-structures-negotiations-get-tough.png" alt="Protect the floor when negotiations get tough — quotes below the margin floor trigger approval" />
</figure>
