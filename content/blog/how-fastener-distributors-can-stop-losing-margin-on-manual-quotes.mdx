**TL;DR:** Manual quoting causes fastener and MRO distributors to lose margin through stale pricing, inconsistent discounting, and no enforced margin floor. Fixing it means automating tiered/contract pricing at the line level, enforcing a system-level margin floor, and keeping one source of truth for pricing — not asking reps to work faster inside the same broken process.
